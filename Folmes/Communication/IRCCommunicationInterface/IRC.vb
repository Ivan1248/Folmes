...
Public Class IrcClient
    ...
    Private _port As Int32 = 6667 '-- the port to connect to.  Default is 6667
    ...
    Private _userName As String = "nodi_the_bot" '-- Unique name so of the IRC network has a unique handle to you regardless of the nickname.
    ...
    Public Sub New(ByVal server As String, ByVal channel As String, ByVal port As Int32, ByVal invisible As Boolean)
        _server = server
        _channel = channel
        _port = port
